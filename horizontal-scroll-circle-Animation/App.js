...
//   const circleWidth = 100;  // The width of the circle
//   const translateXValue = (width - circleWidth) / 2;  // Calculate the center of the screen minus half of the circle width
